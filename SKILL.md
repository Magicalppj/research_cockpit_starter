...
research-cockpit complete-experiment --root research_cockpit --id <experiment_id> --finding "..." --confidence medium --evidence-path outputs/run_x --evidence-link metrics=outputs/run_x/metrics.json --no-build
research-cockpit complete-experiment --root research_cockpit --id <experiment_id> --finding "..." --confidence medium --evidence-path outputs/run_x --evidence-link metrics=outputs/run_x/metrics.json --json --compact
