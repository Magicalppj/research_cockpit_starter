...
def command_role_contract(
    ...
    *,
    ...
    route_kind = "facade" if name == "work open" else "legacy"
    ...
    return {
        ...
        "input_schema_version": "work_open_v1" if name == "work open" else "legacy_flags_v1",
        "output_schema_version": "work_packet_v1" if name == "work open" else "legacy_result_v1",
