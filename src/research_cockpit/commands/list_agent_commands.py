...
COMMANDS: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "supports_compact": True,
        "extra_supported_flags": ASSIGNMENT_SCOPE_FLAGS,
        "fields_supported": ["status", "finished_at", "progress_file", "log_root", "output_root", "monitor_command", "stop_command"],
    ...
    },
    {
        ...
        "supports_compact": True,
        "primary_target": "--id",
        "fields_supported": ["run_id", "status", "experiment_id", "monitor_command", "stop_command", "progress_file"],
