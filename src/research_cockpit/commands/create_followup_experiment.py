...
def create_followup_experiment(
    ...
    *,
    ...
    node_id = node_id or generate_runtime_id(
        "experiment",
        scope_hint=assignment_id or str(resolved_parent),
        slug_hint=title,
    )
...
def main() -> None:
    ...
    parser.add_argument("--id", dest="node_id", help="Optional legacy id override; runtime-generated by default.")
