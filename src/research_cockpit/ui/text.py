...
UI_TEXT = {
    "zh": {
        ...
        "dashboard": "总览",
        "coordination": "协同概览",
        "coord_status_filter": "状态筛选",
        "coord_ready": "可开始",
        "coord_waiting": "等待依赖",
        "coord_stale_inputs": "输入过期",
        "coord_pending_review": "待审核",
        "coord_expired_leases": "租约过期",
        "coord_no_assignments": "当前筛选下没有 assignment。",
        "coord_next_page": "下一页",
        "coord_first_page": "返回第一页",
        "coord_overlap_warnings": "写入范围冲突",
        ...
        "hide_inactive_option_branches": "隐藏非 active option 分支",
        "show_baseline_lens": "显示 Baseline Lens",
        "legend": "图例",
        ...
        "effective_baseline": "有效 Baseline",
        "baseline_source": "Baseline 来源",
        "baseline_source_kind": "来源类型",
        "baseline_artifacts": "Baseline 产物",
        "experiment_uses_baseline": "当前实验基于这个 baseline。",
        "no_effective_baseline": "当前节点没有可解析的 baseline。",
    ...
    "en": {
        ...
        "coord_status_filter": "Status filter",
        "coord_ready": "Ready",
        "coord_waiting": "Waiting",
        "coord_stale_inputs": "Stale inputs",
        "coord_pending_review": "Pending review",
        "coord_expired_leases": "Expired leases",
        "coord_no_assignments": "No assignments match the current filter.",
        "coord_next_page": "Next page",
        "coord_first_page": "First page",
        "coord_overlap_warnings": "Writer scope conflicts",
        ...
        "hide_inactive_option_branches": "Hide inactive option branches",
        "show_baseline_lens": "Show Baseline Lens",
        "legend": "Legend",
        ...
        "baseline_source_kind": "Source Kind",
        "baseline_artifacts": "Baseline Artifacts",
        "experiment_uses_baseline": "This experiment is based on this baseline.",
        "no_effective_baseline": "No effective baseline resolves for this node.",
...
EXTRA_UI_TEXT = {
    "zh": {
        ...
        "claim_option_command": "分配方案工作流命令",
    ...
    "en": {
        ...
        "claim_option_command": "Assign Option Workstream Command",
