...
research-cockpit context --root research_cockpit --id problem_new --view execution --compact --json
```
...
research-cockpit context --root D:/main_repo/research_cockpit --id experiment_x --view execution --compact --json
```
