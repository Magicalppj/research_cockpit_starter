...
2. Read `research_cockpit/dashboards/agent_context_pack.json`, then `research_cockpit/dashboards/focus_context_pack.json`.
3. Use `search_knowledge.py` for targeted note/YAML/resource search.
4. Use mutating scripts for YAML writes; avoid manual edits unless a script does not cover the operation.
